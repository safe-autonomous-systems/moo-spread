...
from solver import HvMaximization
...
if __name__ == '__main__':
    ...
    if args.mode == "solve":
        ...
        args.input_dim = problem.n_var # some problems have specific input dimensions
        ...
        HVGradSolver = HvMaximization(n_mo_sol=args.num_samples,
                                      n_mo_obj=problem.n_obj,
        ...
        with tqdm(
            ...
            for i in range(args.iters):
                ...
                alphas = HVGradSolver.compute_weights(y_np.T).T
