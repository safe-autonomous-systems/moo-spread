...
from solver.mgda_core import solve_mgda
from solver.gradient import get_moo_Jacobian_batch
...
class PMGDACore():
    def __init__(self, n_var, prefs):
        ...
        self.h_eps = 0.01 # self.config['h_eps']
        self.sigma = 0.95 # self.config['sigma']
...
class PMGDASolver(object):
    ...
    def __init__(self, problem, prefs, n_prob, n_obj, step_size=1e-3, n_epoch=500, tol=1e-3,
        ...
        self.core_solver = PMGDACore(n_var=problem.n_var, prefs=prefs)
        self.prefs = prefs
