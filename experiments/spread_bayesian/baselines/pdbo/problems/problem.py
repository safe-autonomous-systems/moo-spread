...
class Problem(PymooProblem):
    ...
    def __init__(self, n_var, n_obj, xl, xu, **kwargs):
        # forward everything to the base initializer
        super().__init__(
            n_var=n_var,
            n_obj=n_obj,
            xl=xl,
            ...
            # **kwargs     # this passing of kwargs is what sets elementwise_evaluation
        )
    ...
    def evaluate(self,
        ...
        # Call your internal evaluator to fill an output dict
        out = {}
        # _evaluate must write into out["F"], out["CV"], etc.
        self._evaluate(X, out, *args, return_values_of=return_values_of, **kwargs)
        ...
        return_values_of = [val for val in return_values_of if val not in ["feasible"]]
    ...
    def _evaluate(self, x, out, *args, return_values_of=None, **kwargs):
        ...
        if "G" in return_values_of or "CV" in return_values_of:
