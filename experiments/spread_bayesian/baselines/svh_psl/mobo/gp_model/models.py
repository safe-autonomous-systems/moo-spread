...
class GP_Model:
    ...
    def __init__(self, X, y, training_iters=200, inference_type='MLE', 
                 learning_rate=0.5, noise_constraint=1e-5, gpu=True, nu=2.5,
                 lengthscale_prior=None, outputscale_prior=None,
                 noise_prior=None, n_restarts=0, device = None
                 ):
        """        
        Parameters
        ----------
    ...
    def mle(self, X, y):
        ...
        loss = optimize_mll(self.model, self.likelihood, X, y, 
    ...
    def predict(self, points):
        ...
        # Make predictions
        points = to_torch(points, gpu=self.gpu, device = self.device)
    ...
    def variance(self, points):
        ...
        var = self.model(points).variance
