...
from hgraph import *
from props.properties import drd2, penalized_logp, qed
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        choices=["qed", "drd2", "SARS", "Antibiotic", "logp", "bace", "bbbp", "hiv"],
    )
    ...
    batches = [
        (data[i : i + batch_size], args.prop) for i in range(0, len(data), batch_size)
    ]
