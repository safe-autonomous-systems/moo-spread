...
# import hgraph
from .hgraph import HierVAE, MoleculeDataset, PairVocab, common_atom_vocab
...
class Chemprop(object):
    ...
    def predict_single(self, smiles):
        return self.predict([smiles], num_workers=0)[0]

    def predict(self, smiles, batch_size=500, num_workers=0):
